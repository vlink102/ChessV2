...
public class ChessMenu extends Menu {
    ...
    public void openProfileMenu(String uuid) {
        JPanel panel = new JPanel();
            ...
            public void actionPerformed(ActionEvent e) {
                FileFilter filter = new FileFilter() {
                    ...
                    public boolean accept(File f) {
                        ...
                        return f.isDirectory() || (name.endsWith(".png") || name.endsWith(".jpeg") || name.endsWith(".jpg"));
                    }
        ...
        saveChanges.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CommunicationHandler.setString("pfp", pfp[0].equals("") ? "" : pfp[0]);
    ...
    private void refresh(PlaceholderTextField usernameTextField, PlaceholderTextField passwordField, String uuid, JSpinner spinner, JComboBox<CountryCode> locationComboBox, PlaceholderAreaField aboutMeArea, String[] pfp, JLabel icon) {
